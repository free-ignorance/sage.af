  ...
  <Layout>
    ...
    <PreStyle>
      <br/>
			...
			<p>Your Account and Data Can be deleted after signup at anypoint on our <a href='/outout'>Delete Account Page</a>, which will delete all customer information from the shopify shop, and remove your email from future promotions.</p>
		</PreStyle>
  </Layout>
)
